...
public:
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Player Actions") bool bBindDefaultActionKeys = true;
    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Player Actions") bool bUseSomersaultVisual = true;
