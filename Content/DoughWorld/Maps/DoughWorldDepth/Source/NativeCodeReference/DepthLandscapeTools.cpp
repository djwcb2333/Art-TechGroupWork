...
{
#if WITH_EDITOR
    const FString CandidateRoot(TEXT("/Game/Maps/DoughWorldDepth/"));
    const FString ExternalActorRoot(TEXT("/Game/__ExternalActors__/Maps/DoughWorldDepth/"));
    ...
    {
        UE_LOG(LogDepthLandscapeTools, Error, TEXT("Visibility import is restricted to non-PIE editor maps under /Game/Maps/DoughWorldDepth/."));
        return false;
    }
